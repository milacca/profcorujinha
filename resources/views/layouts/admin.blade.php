...
<head>
    ...
    <link rel ="SHORTCUT ICON" href="https://professoracorujinha.com.br/images/icon.png"/>
    ...
    <div class="wrapper">
        ...
        <footer class="main-footer">
            <div class="float-right d-none d-sm-block">
                Desenvolvido com <span style="color:#ff7a9f;">♥</span> por <b>Camila Almeida</b>
            </div>
...
<script>
    ...
    $(document).on('click', '.category-filter', function(e) {
        ...
        $.ajax({
            url: '/admin/products/filter/' + categoryId, // URL da rota com o ID da categoria
            type: 'GET',
            success: function(data) {
                // 'data' contém os produtos da categoria
                console.log(data);

                // Atualize sua tabela ou outra parte da interface com os produtos
                // Exemplo: supondo que você tenha uma função para atualizar a tabela
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        let initialData = [1, 2, 5, 1, 1, 5, 8, 3, 4, 7, 2, 1];
        ...
        let chart = createChart(initialData);
        ...
        document.getElementById('downloadButton').addEventListener('click', function () {
            ...
            const newDownloadData = initialData.map(value => value + 10);

            updateChart(newDownloadData);

            initialData = newDownloadData;
        });
    });
</script>
