...
<div style="margin-bottom: 15px;" class="row">
    <div class="col-md-auto">
        <h1>Cadastrar {{ trans('cruds.product.title_singular') }}</h1>
      </div>
</div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pdf_file') ? 'is-invalid' : '' }}" type="file" name="pdf_file" id="pdf_file" accept=".pdf">
