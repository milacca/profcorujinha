        ...
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route("profile.password.update") }}">
                    @csrf
                    <div class="form-group">
                        <label class="required" for="password">Nova {{ trans('cruds.user.fields.password') }}</label>
                    ...
                    <div class="form-group">
                        <label class="required" for="password_confirmation">Confirme Nova {{ trans('cruds.user.fields.password') }}</label>
...
<div class="row">
    <div class="col-md-6">
        <div style="margin-bottom: 15px;" class="row">
            <div class="col-md-auto">
                <h1>{{ trans('global.delete_account') }}</h1>
              </div>
        </div>
        <div class="card">
            <div class="card-body">
